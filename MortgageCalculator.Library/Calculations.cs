...
namespace MortgageCalculator.Library
{
    ...
    {
        static public decimal MaxRepayPerYear(this decimal principal, double maxRepayPerYear, bool isDisplayValue)
        {
        ...
        static public decimal TotalPayment(decimal monthlyPayment, int duration, bool isDisplayValue)
        {
            decimal output = 0;
        ...
        static public decimal TotalInterest(decimal totalPayment, decimal principal, bool isDisplayValue)
        {
            decimal output = 0;
        ...
        static public decimal MonthlyPayment(decimal principal, double interest, int duration, bool isDisplayValue)
        {
            decimal output = 0;
        ...
        static public decimal MonthlyInterest(decimal principal, double interest)
        {
            decimal output = 0;
        ...
        static public List<MortgagePaymentModel> MortgageCalculations(QuestionnaireModel answer)
        {
        ...
        static public double MonthlyInterestRate(this double interest)
        {
            return interest / 100 / 12;
        }
        static public int CalculateTotalMonths(this int years)
        {
            return years * 12;
        }
    }
